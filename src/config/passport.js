...
const jwtVerify = async (payload, done) => {
  ...
  // if(payload.tokenTypes !== 'ACCESS'){
  //   done( new Error('Invalid token type'), false)
  // }
  
  // const user  = await User.findById(payload.sub) //we will find user by its id to check if the person with this password exist or not
