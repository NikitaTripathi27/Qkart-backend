...
// const exptime = Math.floor(Date.now()/1000) + config.jwt.accessExpirationMinutes;
// const exptime  = new Date();
// exptime.setUTCSeconds(exptime.getUTCSeconds() + config.jwt.accessExpirationMinutes)
const exptime = Math.floor(Date.now()/1000) + config.jwt.accessExpirationMinutes * 60 ;
